...
Calculate::Calculate(QWidget* parent) :
    ...
    b = 3;
    pA = new
        QLineEdit(QString::number(a));
    pB = new
        QLineEdit(QString::number(b));
    pSum = new
        QLineEdit(QString::number(a + b));
    pProduct = new
        QLineEdit(QString::number(a * b));
    QHBoxLayout* pHLayoutA =
        new QHBoxLayout;
    pHLayoutA->addWidget(pLabelA);
    pHLayoutA->addWidget(pA);
    QHBoxLayout* pHLayoutB =
        new QHBoxLayout;
    pHLayoutB->addWidget(pLabelB);
    pHLayoutB->addWidget(pB);

    pButton = new QPushButton(
      "Compute a + b and a x b");
    QHBoxLayout* pHLayoutSum =
        new QHBoxLayout;
    pHLayoutSum->addWidget(pLabelSum);
    pHLayoutSum->addWidget(pSum);
    QHBoxLayout* pHLayoutProduct =
        new QHBoxLayout;
    pHLayoutProduct->
        addWidget(pLabelProduct);
    pHLayoutProduct->
        addWidget(pProduct);
...
//Ammeraal, Leen.Computer Graphics Programming in C++ / Qt(pp. 16 - 17).UNKNOWN.Kindle Edition.
